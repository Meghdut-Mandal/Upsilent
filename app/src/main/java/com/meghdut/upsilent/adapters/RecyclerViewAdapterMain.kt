 ...
 */
class RecyclerViewAdapterMain(private val mMovies: Array<MovieResponse?>?, var mContext: Context) : RecyclerView.Adapter<RecyclerViewAdapterMain.ViewHolder>(), OnRecyclerViewItemClickListener {
